...
|----------|-------------|
| `GET /v2/tickets/:id` | Ticket detail; `classification`, `citizen_identity`, `status_history` (stage/sub-status timeline); `has_notes_or_attachments` → skip `GET .../attachments` when `false` |
