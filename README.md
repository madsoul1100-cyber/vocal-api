...
| `GET /v2/dashboard/web/charts/tickets-by-category-monthly` | Stacked bar time series — tickets by category per calendar month (`months` default 6). Territory only; no date filter. |
